...
function M.help_cmd(ctx, args)
    local text = "**fly-telegram**\n\n"
        ...
        .. "`.ip`, `.domain`, `.rdap` - OSINT lookups  \n"
        .. "`.dl`, `.sendfile`, `.urlupload`, `.rename` - file tools  \n"
        .. "`.type`, `.scroll`, `.magic`, `.heart` - text animations  \n"
        .. "`.ai`, `.ask`, `.summarize`, `.translate`, `.transcribe` - multi-provider AI helper  \n"
        .. "`.cleanjoins on|off`, `.captcha on|off` - group protection  \n"
        .. "`.gifts`, `.taskbot` - dry-run automation hooks  \n"
        .. "`.play`, `.queue`, `.skip`, `.stop` - external music worker controls  \n"
